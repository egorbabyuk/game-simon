...
template <> constexpr inline auto Game::qt_create_metaobjectdata<qt_meta_tag_ZN4GameE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'player_start'
        QtMocHelpers::SlotData<void(SimpleCube *)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 7, 2 },
        }}),
    };
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->next_round(); break;
        case 2: _t->switch_to_menu(); break;
        case 3: _t->start(); break;
        case 4: _t->player_start((*reinterpret_cast< std::add_pointer_t<SimpleCube*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Game::*)()>(_a, &Game::target_cube, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)()>(_a, &Game::next_round, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)()>(_a, &Game::switch_to_menu, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)()>(_a, &Game::start, 3))
            return;
    }
}
